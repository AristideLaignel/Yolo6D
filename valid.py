    ...
    for batch_idx, (data, target) in enumerate(test_loader):
        ...
        for box_pr, target in zip([all_boxes], [target[0]]):
            ...
            for k in range(num_gts):
                ...
                count = count + 1
                color = (255, 0, 0)
                #img = plot_3dboxes(image,corners2D_pr, color=color)
                plot_3dboxes(image,corners2D_gt,"images/1AGorilla3D"+str(batch_idx)+".png")
                ...
                if save:
                    ...
                    try:
                        ...
                        print("Can't save the data "+str(count))
